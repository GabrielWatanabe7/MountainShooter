...
class Score:
    ...
    def save(self, game_mode: str, player_score: list[int]):
        ...
        while True:
            ...
            self.score_text(text_size=48, text='YOU WIN!', text_color=C_YELLOW, text_center_pos= SCORE_POS['Title'])
            if game_mode == MENU_OPTION[0]:
                score = player_score[0]
                text = 'Player 1 enter your name (In 4 characters):'
            if game_mode == MENU_OPTION[1]:
                score = (player_score[0] + player_score[1])/2
                text = 'Enter your Team name (In 4 characters):'
            if game_mode == MENU_OPTION[2]:
                if player_score[0] >= player_score[1]:
                 ...
                 text = 'Player 2 enter your name (In 4 characters):'
